...
GRANT USAGE ON SCHEMA public TO tuist_swift_registry_sync;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON oban_jobs, oban_peers TO tuist_swift_registry_sync;
GRANT USAGE, SELECT ON SEQUENCE oban_jobs_id_seq TO tuist_swift_registry_sync;
...
REVOKE ALL ON ALL TABLES IN SCHEMA public FROM tuist_swift_registry_sync;
GRANT SELECT, INSERT, UPDATE, DELETE ON oban_jobs, oban_peers TO tuist_swift_registry_sync;
...
WHERE grantee = 'tuist_swift_registry_sync'
